...
\newcommand{\versuch}{Ferromagnetische Hysteresis} % Name des Versuchs
...
\newcommand{\betreuer}{Dario Mekle}      % Name des zuständigen Betreuers
\newcommand{\durchgefuehrt}{16.12.21}      % Datum, an dem der Versuch 
                                           % durchgeführt wurde
