...
\newcommand{\versuch}{e/m-Bestimmung} % Name des Versuchs
...
\newcommand{\betreuer}{Valentin Reutter}      % Name des zuständigen Betreuers
\newcommand{\durchgefuehrt}{09.12.21}      % Datum, an dem der Versuch 
                                           % durchgeführt wurde
