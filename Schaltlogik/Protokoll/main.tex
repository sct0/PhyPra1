...
\newcommand{\versuch}{Schaltlogik}         % Name des Versuchs
...
\newcommand{\betreuer}{Julian Feiler}         % Name des zuständigen Betreuers
\newcommand{\durchgefuehrt}{02.12.21}      % Datum, an dem der Versuch 
                                           % durchgeführt wurde
