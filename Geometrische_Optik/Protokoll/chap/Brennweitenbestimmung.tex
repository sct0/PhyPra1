...
An den Werten der Tabelle (\ref{tab:Mittelwerte}) ist klar ersichtlich, dass es eine große Abweichung zum auf der Linse angegebenen Wert gibt, der auch nicht mehr innerhalb des Fehlers liegt. Was an verschiedenen Faktoren liegen könnte, es besteht die Möglichkeit, dass die Beschriftung der Linse nicht korrekt ist oder, dass bei einer anderen Wellenlänge gemessen wurde oder noch deutlich näher an der Achse gemessen wurde, dass es sich um personenabhängige Fehler handelt, wobei dies fast ausgeschlossen werden kann, da alle Werte nah beieinander liegen, auch eine große Streuung ist nicht feststellbar. Eine andere Erklärung wäre, dass sich das Bild nicht zu 100\% scharf stellen lässt, da bei dieser Linse entweder der innere Bereich des Bilds scharf gestellt werden konnte oder der äußere. Außerdem lässt sich deutlich die Abweichung von dem Ergebnis der einfachen Brennweitenbestimmung erkennen, was wahrscheinlich der genaueren Messmethode zu verdanken ist.\\
Abgesehen davon kann man an den Mittelwerten zusammen mit den Fehlern für die Brennweiten der einzelnen Konfigurationen relativ deutlich die chromatische Abberation der Linse erkennen. Dahingegen lässt sich die spärische Abberation nur kaum bis gar nicht erkennen, vor allem mit dem errechneten Fehler. Daher lässt sich auf eine geringe spärische Abberation schließen.
