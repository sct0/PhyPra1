...
Wenn man nun mit zwei Messwertpaaren $(x_1, \gamma_1), (x_2, \gamma_2)$ f errechnet, kann man dieses in \ref{1} verwenden um $h_1$ zu erhalten.
...
\begin{figure}[h!]{}
    \begin{center}
        \includegraphics[scale=0.4]{Geometrische_Optik/Protokoll/fig/Abbe_Reg_Messreihe1.png}
...
\begin{figure}[h!]{}
    \begin{center}
        \includegraphics[scale=0.4]{Geometrische_Optik/Protokoll/fig/Abbe_Reg_Messreihe2.png}
